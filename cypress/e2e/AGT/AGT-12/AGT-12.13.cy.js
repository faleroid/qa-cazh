...
describe('AGT-12.13 - Cari riwayat kesehatan dengan keyword Keterangan', () => {
  beforeEach(() => {
    cy.login();
  });

  it('AGT-12.13: Cari riwayat kesehatan dengan keyword Keterangan -> Tambah riwayat kesehatan dulu jika kosong, lalu cari', () => {
    ...
    // Lakukan pencarian berdasarkan keyword Keterangan
