...
describe('AGT-12.28 - Centang checkbox pada header tabel', () => {
  ...
  it('AGT-12.28: Centang checkbox pada header tabel -> Seluruh data pada halaman aktif terpilih; muncul banner Terpilih dan Pilih Semua', () => {
    ...
    // Centang checkbox pada header tabel (thead th)
    ...
    // Assert Tombol "Terpilih {n}" dan "Pilih semua {n}"
