...
describe('AGT-12.12 - Cari riwayat kesehatan dengan keyword Tindakan', () => {
  beforeEach(() => {
    cy.login();
  });

  it('AGT-12.12: Cari riwayat kesehatan dengan keyword Tindakan -> Tambah riwayat kesehatan dulu jika kosong, lalu cari', () => {
    ...
    // Lakukan pencarian berdasarkan keyword Tindakan
