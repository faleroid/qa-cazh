...
describe('AGT-14.13: Poin positif 1-100 diterima', () => {
  beforeEach(() => { cy.login(); cy.wait(1000); });

  it('AGT-14.13: Poin positif 1-100 diterima', () => { openPrestasi(); openForm(); cy.get('[role="dialog"] input[type="number"], [role="dialog"] input[name="point"]').first().clear().type('25').should('have.value', '25'); });
});
