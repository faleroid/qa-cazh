...
describe('AGT-14.1: Pada halaman Detail Siswa, klik tab Prestasi', () => {
  beforeEach(() => { cy.login(); cy.wait(1000); });

  it('AGT-14.1: Pada halaman Detail Siswa, klik tab Prestasi', () => { openPrestasi(); cy.get('body').should('contain.text', 'Prestasi'); });
});
