...
describe('AGT-14.10: Klik tombol Tambah Prestasi', () => {
  beforeEach(() => { cy.login(); cy.wait(1000); });

  it('AGT-14.10: Klik tombol Tambah Prestasi', () => { openPrestasi(); openForm(); cy.get('[role="dialog"]').should('contain.text', 'Prestasi'); });
});
