...
describe('AGT-14.20: Klik Batal', () => {
  beforeEach(() => { cy.login(); cy.wait(1000); });

  it('AGT-14.20: Klik Batal', () => { openPrestasi(); openForm(); cy.get('[role="dialog"]').contains('button', /batal/i).click({ force: true }); cy.get('[role="dialog"]').should('not.exist'); });
});
