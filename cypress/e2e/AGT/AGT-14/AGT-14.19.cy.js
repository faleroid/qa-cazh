...
describe('AGT-14.19: Isi semua field dan simpan', () => {
  beforeEach(() => { cy.login(); cy.wait(1000); });

  it('AGT-14.19: Isi semua field dan simpan', () => { openPrestasi(); openForm(); fillPrestasi(); cy.get('[role="dialog"]').should('not.exist'); });
});
