...
describe('AGT-14.44: Cek isi kolom export', () => {
  beforeEach(() => { cy.login(); cy.wait(1000); });

  it('AGT-14.44: Cek isi kolom export', () => { openPrestasi(); cy.get('body').should(($body) => { expect($body.text()).to.match(/Instansi|Nama Siswa|Tanggal Kejadian|Kategori Prestasi|Deskripsi|Apresiasi|Poin|Dibuat Oleh/i); }); });
});
