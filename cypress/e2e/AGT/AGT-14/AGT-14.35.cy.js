...
describe('AGT-14.35 - Pada popup bulk delete, klik tombol Batal', () => {
  beforeEach(() => {
    cy.login();
    cy.wait(1000);
  });

  it('AGT-14.35: Pada popup bulk delete, klik tombol Batal -> Popup tertutup & data tidak terhapus', () => {
    ...
    // 4. Klik tombol Batal di dalam dialog
