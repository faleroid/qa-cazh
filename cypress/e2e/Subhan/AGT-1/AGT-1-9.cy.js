describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.9	Aktifkan Filter kombinasi (Tahun Ajaran + Semester + Jurusan + Tingkat + Kelas)	List filter sesuai kombinasi (7 kriteria filter tersedia: Instansi, Tahun Ajaran, Semester, Jurusan, Tingkat, Kelas, Status Pengkinian Data)', () => {
