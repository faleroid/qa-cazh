describe('Anggota - Siswa - Edit Profil Siswa', () => {
  ...
  it('AGT-1.31	Isi No HP tidak dimulai dengan 08 atau 62 (misal "7123456789") → klik Simpan	Sistem tolak dengan error No HP harus dimulai dengan 08 atau 62', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .click()
    cy.get('[name="name"]').type('tes phone', { delay: 100 })
