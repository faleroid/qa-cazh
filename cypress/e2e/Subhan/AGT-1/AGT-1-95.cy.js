describe('Anggota - Siswa - Import Siswa', () => {
  ...
  it('AGT-1.95	Import dengan Nomor Kartu bukan 16 digit di template	Baris tsb TIDAK dapat diimport, ditampilkan di log import', () => {
    ...
    cy.get('input[type="file"]')
      .selectFile('cypress/fixtures/wrongIDCARD.xls', {
        force: true
      })
