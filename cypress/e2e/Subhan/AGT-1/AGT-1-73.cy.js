describe('Anggota - Siswa - Tambah Siswa', () => {
  ...
  it('AGT-1.73	Isi semua 16 field required Data Diri + valid Nomor Kartu → klik Simpan	Toast success, siswa baru ter-add ke list', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .click()
    cy.get('[name="name"]').type('tes2', { delay: 100 })
