describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.22	Aktifkan Filter History Siswa (pilih Tahun Ajaran/Tingkat/Kelas/Semester lama)	Semua tab (1-11) menampilkan data sesuai filter yang dipilih (history-based view)', () => {
    ...
    cy.contains('tr', 'Test20')
      ...
      .click()
    cy.wait(3000)
    cy.contains('[data-slot="popover-trigger"]', 'Filter').eq(0).click()
    ...
    //tidak ada dropdown semester tidak terisi
    //     cy.get('[data-radix-popper-content-wrapper]').within(() => {
