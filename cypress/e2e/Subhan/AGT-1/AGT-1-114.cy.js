describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.114	Klik tombol Cetak pada Surat Orang Tua	Sistem membuka dialog print browser untuk mencetak Surat Orang Tua (dapat Save as PDF)', () => {
    ...
    cy.get('[href="/member/student/127/print-letter"]').invoke('removeAttr', 'target').click()
    cy.wait(1000)

    cy.contains('button', 'Cetak Surat Orang Tua').click()
    cy.wait(1000)
  })
