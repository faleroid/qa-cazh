describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.123	Cek isi PDF hasil download	PDF menampilkan design kartu sesuai template instansi + informasi kartu (Nomor Kartu, Nama Siswa, QR Code)', () => {
    ...
    cy.contains('button', 'Unduh Kartu').click()
    cy.wait(1000)
  })
