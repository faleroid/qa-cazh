describe('Anggota - Siswa - Import Siswa', () => {
  ...
  it('AGT-1.101	Search di Log Import by instansi/tahun ajaran/tingkat/kelas/jurusan	List menampilkan log import yang match dengan keyword', () => {
    ...
    cy.wait(1000)
    cy.get('[data-slot="input"]').type('3{enter}') //gk bisa pakai nama instansi
