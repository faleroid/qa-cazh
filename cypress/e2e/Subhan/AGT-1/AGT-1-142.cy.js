describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.142	Klik Aksi Detail pada row tugas di Tab Tugas	Sistem mengarahkan ke halaman Detail Tugas Pengumpulan (referensi ke AKD-16 Detail Tugas → Pengumpulan)', () => {
