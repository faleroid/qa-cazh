describe('Anggota - Siswa - Tambah Siswa', () => {
  ...
  it('AGT-1.82	Isi Nomor Kartu 16 digit TAPI tidak sesuai membership partner → klik Simpan	Sistem cek nomor kartu, tolak dengan pesan error (Nomor kartu tidak sesuai dengan membership partner)', () => {
    ...
    cy.get('[role="listbox"]')
      .contains('9D')
      .click()
    cy.get('[name="card_no"]').type('1002992414737111', { delay: 100 })
