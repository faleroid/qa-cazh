describe('Anggota - Siswa - Tambah Siswa', () => {
  ...
  it('AGT-1.74	Skip Data Orang Tua (semua opsional) + isi Data Diri required → Simpan	Data berhasil disimpan (Data Orang Tua semua opsional)', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .click()
    cy.get('[name="name"]').type('tes3', { delay: 100 })
