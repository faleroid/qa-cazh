describe('Anggota - Siswa - Import Siswa', () => {
  ...
  it('AGT-1.96	Import dengan Nomor Kartu tidak sesuai membership partner	Baris tsb TIDAK dapat diimport, ditampilkan di log import', () => {
    ...
    cy.get('input[type="file"]')
      .selectFile('cypress/fixtures/IDCARDNOTFOUND.xls', {
        force: true
      })
