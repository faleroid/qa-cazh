describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.104	Cek section Info Kartu pada tab Kartu	Menampilkan Design Kartu (visual), Nomor Kartu (16 digit), QR Code (scannable), UID Kartu, Status (Aktif/Blokir), RFID, Terakhir Ganti PIN', () => {
