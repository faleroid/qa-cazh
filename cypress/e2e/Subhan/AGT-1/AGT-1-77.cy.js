describe('Anggota - Siswa - Tambah Siswa', () => {
  ...
  it('AGT-1.77	Isi No HP tidak dimulai 08 atau 62	Sistem tolak dengan error No HP harus dimulai 08 atau 62', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .click()
    cy.get('[name="name"]').type('tes5', { delay: 100 })
    cy.get('[name="phone"]').type('1111111111111', { delay: 100 })
