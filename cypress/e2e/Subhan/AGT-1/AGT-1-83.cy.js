describe('Anggota - Siswa - Tambah Siswa', () => {
  ...
  it('AGT-1.83	Klik Batal di form Tambah Siswa	Form tertutup, sistem kembali ke halaman list siswa, data tidak tersimpan', () => {
    ...
    cy.get('[role="listbox"]')
      ...
      .click()
    cy.get('[name="name"]').type('tes batal', { delay: 100 })
