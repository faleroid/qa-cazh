describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.39	Klik tombol "Print Data Siswa"	Sistem generate PDF berisi data siswa lengkap: Data Diri (28+13+4 fields), Data Orang Tua (20 fields), Informasi Penghasilan', () => {
    ...
    cy.contains('button', 'Cetak Biodata').click()
