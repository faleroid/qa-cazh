describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.17	Search data → klik Export Excel	Sistem hanya export data hasil pencarian yang ditampilkan (bukan semua)', () => {
    ...
    cy.wait(2000)
    cy.get('[data-slot="input"]').type('Sekolah', { delay: 100 })
    cy.wait(2000)
