describe('Anggota - Siswa - Import Siswa', () => {
  ...
  it('AGT-1.93	Import template Anggota dengan baris yang Email kosong	Baris tsb TIDAK diimport, ditampilkan di log import dengan keterangan error "Email wajib diisi"', () => {
    ...
    cy.get('input[type="file"]')
      .selectFile('cypress/fixtures/email.xls', {
        force: true
      })
