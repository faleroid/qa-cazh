describe('Anggota - Siswa ', () => {
  ...
  it('AGT-1.43	Isi Penghasilan Orang Tua → klik Simpan	Toast success, penghasilan ter-update di section Informasi', () => {
    ...
    cy.wait(1000)
    cy.get('[name="family.father_name"]').clear().type('xy', { delay: 100 })
    cy.get('[name="family.mother_name"]').clear().type('xx', { delay: 100 })
