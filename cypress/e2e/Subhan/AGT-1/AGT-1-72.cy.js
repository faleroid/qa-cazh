describe('Anggota - Siswa - Tambah Siswa', () => {
  ...
  it('AGT-1.72	Klik btn "Tambah Siswa" di halaman list	Form Tambah Siswa terbuka dengan 2 section: Data Diri (17 field) + Data Orang Tua (8 field)', () => {
    ...
    //   .click()
    // cy.get('[name="name"]').type('tesssss', { delay: 100 })
