describe('Anggota - Siswa - Import Siswa', () => {
  ...
  it('AGT-1.94	Import template Anggota dengan baris yang Email format tidak valid (misal "namadomain.com")	Baris tsb TIDAK diimport, ditampilkan di log import dengan keterangan error "Format email tidak valid"', () => {
    ...
    cy.get('input[type="file"]')
      .selectFile('cypress/fixtures/wrongemail.xls', {
        force: true
      })
