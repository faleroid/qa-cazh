describe('Anggota - Siswa - Import Siswa', () => {
  ...
  it('AGT-1.91	Upload Foto Siswa (Jenis Import Foto) dengan ukuran > 2MB	Sistem tolak foto dengan error "Ukuran foto maksimal 2MB"', () => {
    ...
    cy.get('input[type="file"]').eq(0)
      .selectFile('cypress/fixtures/test3.png', {
        force: true
      })
