describe('PGT-13.29	Ubah Nama Jenis Staff ke nilai baru → klik Simpan	Toast success, sistem kembali ke list, nama ter-update di list', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('passes', () => {
