describe('PGT-13.13	Input Nama Jenis Staff dengan spasi di awal & akhir (misal " Staff TU  ") → klik Simpan	Data disimpan sebagai "Staff TU" (spasi tepi ter-trim otomatis)', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('passes', () => {
