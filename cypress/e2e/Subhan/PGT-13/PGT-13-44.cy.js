describe('PGT-13.44	Search sampai hasil tinggal 1 row → hapus row tersebut	Setelah hapus, sistem menampilkan halaman kosong (empty state UI)', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('passes', () => {
