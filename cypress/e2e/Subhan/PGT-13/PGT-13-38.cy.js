describe('PGT-13.38	Ubah Nama Jenis Staff jadi spasi saja (whitespace only) → klik Simpan	Error "Nama Jenis Staff wajib diisi" muncul (whitespace ter-trim jadi kosong)', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('passes', () => {
