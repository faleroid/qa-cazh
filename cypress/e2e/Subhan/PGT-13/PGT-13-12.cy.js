describe('PGT-13.12	Isi Nama Jenis Staff dengan spasi saja (whitespace only) → klik Simpan	Sistem trim whitespace lalu treat sebagai kosong, error "Nama Jenis Staff wajib diisi" muncul', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('passes', () => {
