describe('PGT-13.9	Input Nama Jenis Staff dengan karakter khusus "!@#$ %^&* " → klik Simpan	Error validasi muncul (nama hanya boleh huruf, angka, atau kombinasi), data tidak tersimpan', () => {
