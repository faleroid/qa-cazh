describe('Pengaturan - Tagihan - Jenis Tagihan - Tambah Jenis Tagihan', () => {
  ...
  it('PGT-14.12	Tambah jenis tagihan dengan Nama + Instansi + Pengulangan + Periode yang SAMA dengan data existing (duplikat)	Sistem tolak duplikat dengan pesan error, data tidak tersimpan (uniqueness by 4-field combo)', () => {
