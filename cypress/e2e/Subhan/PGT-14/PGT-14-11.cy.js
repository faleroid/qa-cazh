describe('PGT-14.11	Kosongkan Periode Tagihan (Tanggal Mulai/Selesai kosong) → klik Simpan	Error "Periode Tagihan wajib diisi" muncul, tombol Simpan tidak bekerja', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('passes', () => {
