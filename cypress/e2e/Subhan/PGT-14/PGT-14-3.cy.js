describe('14. Pengaturan - Tagihan - Jenis Tagihan - Tambah Jenis Tagihan', () => {
  ...
  it('PGT-14.3	Isi form Tambah dengan Pengulangan "Setiap Bulan" + pilih tanggal (misal 10) + Periode valid → klik Simpan	Toast success, data tersimpan dengan konfigurasi monthly pada tanggal 10', () => {
