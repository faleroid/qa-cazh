describe('14. Pengaturan - Tagihan - Jenis Tagihan - Tambah Jenis Tagihan', () => {
  afterEach(() => {
    cy.wait(1500)
  })
  it('PGT-14.2	Isi form Tambah dengan Pengulangan "Setiap Minggu" + pilih hari (misal Senin) + Periode valid → klik Simpan	Toast success, data tersimpan dengan konfigurasi weekly pada hari Senin', () => {
