describe('Pengaturan - Tagihan - Jenis Tagihan - Tambah Jenis Tagihan', () => {
  ...
  it('PGT-14.25	Isi Periode dengan Tanggal Mulai = Tanggal Selesai (pengulangan Sekaligus Lunas) → klik Simpan	Data berhasil disimpan (same-day valid untuk one-time payment)', () => {
