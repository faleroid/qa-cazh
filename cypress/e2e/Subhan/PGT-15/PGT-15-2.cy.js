describe('Pengaturan - Tagihan - Pengingat Tagihan - Tambah Pengingat', () => {
  ...
  it('PGT-15.2	Isi form Tambah lengkap + aktifkan checkbox "Aktifkan Notifikasi WhatsApp" → klik Simpan	Toast success, pengingat tersimpan dengan notifikasi via push notification + WhatsApp (2 channel)', () => {
