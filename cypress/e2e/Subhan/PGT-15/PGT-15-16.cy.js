describe('Pengaturan - Tagihan - Pengingat Tagihan - Tambah Pengingat', () => {
  ...
  it('PGT-15.16	Ubah Pesan setelah pratinjau muncul	Pratinjau ter-update real-time sesuai pesan baru (dynamic preview)', () => {
    ...
    cy.wait(1000)
    cy.get('[name="message"]').clear().type('BISA GK?', { delay: 100 })
