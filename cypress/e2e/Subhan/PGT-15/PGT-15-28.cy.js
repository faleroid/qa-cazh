describe('Pengaturan - Tagihan - Pengingat Tagihan  ', () => {
  ...
  it('PGT-15.28	Ketik keyword Pesan di search box	List filter menampilkan row yang Pesan-nya match dengan keyword', () => {
    ...
    cy.get('[role="listbox"]')
      .contains('100')
      .click()
    cy.get('[data-slot="input"]').type('suk', { Delay: 100 })
    cy.wait(1000)
  })
