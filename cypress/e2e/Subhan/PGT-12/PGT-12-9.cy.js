describe('Pengaturan - Kepegawaian - Jenis Guru - Tambah Jenis Guru', () => {
  ...
  it('PGT-12.9	Input Nama Jenis Guru dengan karakter khusus "!@#$%^&*"" → klik Simpan	Error validasi muncul (nama hanya boleh huruf, angka, atau kombinasi), data tidak tersimpan', () => {
