describe('Pengaturan - Kepegawaian - Jenis Guru  - Edit', () => {
  ...
  it('PGT-12.36	Ubah Nama Jenis Guru jadi karakter khusus "!@#$%^&*" → klik Simpan	Error validasi muncul (nama hanya boleh huruf, angka, atau kombinasi), data tidak tersimpan', () => {
