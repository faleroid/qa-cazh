describe('Pengaturan - Kepegawaian - Jenis Guru - Edit', () => {
  ...
  it('PGT-12.37	Ubah Nama Jenis Guru jadi spasi saja (whitespace only) → klik Simpan	Error "Nama Jenis Guru wajib diisi" muncul (whitespace ter-trim jadi kosong)', () => {
