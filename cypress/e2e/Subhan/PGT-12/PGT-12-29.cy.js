describe('Pengaturan - Kepegawaian - Jenis Guru - Edit', () => {
  ...
  it('PGT-12.29	Ubah Status dari "Aktif" ke "Tidak Aktif" → klik Simpan	Toast success, badge Status di row berubah jadi "Tidak Aktif" (abu), row tetap tampil di list', () => {
